          ...
          <div className="relative h-96 bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl border-4 border-white overflow-hidden">
            {balloons.map((balloon) => (
              <button
                ...
                className={`absolute transition-all duration-300 ${balloon.popped ? 'scale-0 opacity-0' : 'scale-100 opacity-100 hover:scale-110'
                  }`}
                style={{
                  left: `${balloon.x}%`,
                  top: `${balloon.y}%`,
            ...
            {poppedCount >= 5 && (
              <div className="absolute inset-0 flex items-center justify-center bg-white/80 backdrop-blur-sm">
                <div className="text-center">
                  ...
                  <p className="text-xl text-gray-600">Loading Lucerna...</p>
                </div>
              </div>
            )}
          </div>
